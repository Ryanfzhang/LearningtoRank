...
from org.utils.numpy.np_extensions import np_arg_shuffle_ties
...
def iter_lines(lines, has_targets=True, one_indexed=True, missing=0.0, has_comment=False):
    ...
    """
    #将读文件变成一个生成器，每次返回 document_feature, score , qid, 如果有comment，也返回comment
